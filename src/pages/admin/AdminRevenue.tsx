...
export default function AdminRevenue() {
  ...
  const totalFee = mockMonthlyData.reduce((s, m) => s + m.fee, 0);

  return (
    <PageWrapper title="Platform Revenue">
      <div className="grid grid-cols-3 gap-4 mb-8">
        <KpiCard label="Total Gross" value={totalGross} prefix="$" glowColor="green" />
        <KpiCard label="Total Fees Earned" value={totalFee} prefix="$" delay={100} glowColor="neon" />
        <KpiCard label="Avg Fee Rate" value={20} suffix="%" delay={200} />
      </div>
